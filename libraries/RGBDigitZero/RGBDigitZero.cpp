...
RGBDigit::RGBDigit(int nDigits, int pin, neoPixelType t, int segmentsPerDigit)
  : Adafruit_NeoPixel_ZeroDMA(segmentsPerDigit * nDigits, pin, t),
...
void RGBDigit::begin()
{
  ...
  Adafruit_NeoPixel_ZeroDMA::setBrightness(_brightness);
}
...
void RGBDigit::setBrightness(byte brightness){
  ...
  Adafruit_NeoPixel_ZeroDMA::setBrightness(brightness);
}
